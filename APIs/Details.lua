...
NemesisChatAPI:AddAPI("NC_DETAILS", "Details! API")
    ...
    :AddSubject({
        ...
        value = "BYSTANDER_DPS",
        exec = function() return NCDetailsAPI:GetDPS(NCEvent:GetBystander(), DETAILS_SEGMENTID_CURRENT) end,
        operators = core.constants.EXTENDED_OPERATORS,
        type = "NUMBER",
    })
    :AddSubject({
        ...
        value = "MY_DPS",
        exec = function() return NCDetailsAPI:GetDPS(GetMyName(), DETAILS_SEGMENTID_CURRENT) end,
        operators = core.constants.EXTENDED_OPERATORS,
        type = "NUMBER",
    })
    :AddSubject({
        ...
        exec = function() return NCDetailsAPI:GetDPS(NCEvent:GetNemesis(), DETAILS_SEGMENTID_OVERALL) end,
        operators = core.constants.EXTENDED_OPERATORS,
        type = "NUMBER",
    })
    :AddSubject({
    ...
    :AddSubject({
        ...
        exec = function() return NCDetailsAPI:GetDPS(NCEvent:GetBystander(), DETAILS_SEGMENTID_OVERALL) end,
        operators = core.constants.EXTENDED_OPERATORS,
        type = "NUMBER",
    })
    :AddReplacement({
    ...
    :AddReplacement({
        label = "Bystander DPS",
        value = "BYSTANDERDPS",
        exec = function() return NemesisChat:FormatNumber(NCDetailsAPI:GetDPS(NCEvent:GetBystander(), DETAILS_SEGMENTID_CURRENT)) end,
    ...
    :AddReplacement({
        label = "My DPS",
        value = "DPS",
        exec = function() return NemesisChat:FormatNumber(NCDetailsAPI:GetDPS(GetMyName(), DETAILS_SEGMENTID_CURRENT)) end,
    ...
    :AddReplacement({
        ...
        exec = function() return NemesisChat:FormatNumber(NCDetailsAPI:GetDPS(NCEvent:GetNemesis(), DETAILS_SEGMENTID_OVERALL)) end,
    ...
    :AddReplacement({
        ...
        exec = function() return NemesisChat:FormatNumber(NCDetailsAPI:GetDPS(NCEvent:GetBystander(), DETAILS_SEGMENTID_OVERALL)) end,
    ...
    :AddReplacement({
        label = "My DPS Overall",
        value = "DPSOVERALL",
        exec = function() return NemesisChat:FormatNumber(NCDetailsAPI:GetDPS(GetMyName(), DETAILS_SEGMENTID_OVERALL)) end,
