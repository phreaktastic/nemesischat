                ...
                realtime = {
                    ...
                    args = {
                        ...
                        affixAuraStacksWarningToggle = {
                            ...
                            desc = "Announce when an enemy or party member has reached a high amount of stacks of a dangerous affix aura. This will be announced in real-time as a yell, and post-combat warnings to wait on pulls will be in party chat.",
                            descStyle = "inline",
                            width = "full",
